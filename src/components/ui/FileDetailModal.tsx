        ...
        <>
          ...
          >
            <div className="filedetail-header">
              ...
              <motion.button className="filedetail-close" onClick={onClose} aria-label={lang === 'ru' ? 'Закрыть' : 'Close'} whileHover={{ scale: 1.1, rotate: 90 }} whileTap={{ scale: 0.9 }} transition={{ type: 'spring', stiffness: 400, damping: 25 }}>
