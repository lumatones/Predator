...
Predator А десктопное приложение для обнаружения следов стороннего ПО (читов) на компьютере пользователя. Проверяет файловую систему, процессы, историю браузера и DMA-устройства.
