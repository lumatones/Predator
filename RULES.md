...
- ✅ Экран чекера: сканирование файлов, 4 режима (files/processes/cheats/dma)
- ✅ Микро-анимации: staggered rows, tab transitions, icon bounce, glow, snap-in, bump и др.
- ✅ GitHub Release v0.0.4 с portable .exe
- ✅ Интеграция приложения с бэкендом через API
- ✅ Автосборка .exe через GitHub Actions workflow
